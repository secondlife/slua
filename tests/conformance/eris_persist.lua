...
-- TODO: We don't support these anymore! Replace them with utag stuff
...
-- TODO: turn this back on when tagged lightuserdata is supported
...
coroutine.yield(ares.persist(perms, rootobj))
