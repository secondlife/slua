...
{
    ++gTestsFailed;
    llOwnerSay("FAILED!: " + description + " (" + actual + " expected " + expected + ")");
...
tests()
{
    ...
    ensureFloatEqual("posinf == posinf", 2.0e+99999, 2.0e+99999);
    ensureFloatEqual("neginf == neginf", -2.0e+99999, -2.0e+99999);
    ensureFalse("posinf != neginf", 2.0e+99999 == -2.0e+99999);
    ensureStringEqual("(string)posinf == 'Infinity'", (string)2.0e+99999, "Infinity");
    ensureStringEqual("(string)neginf == '-Infinity'", (string)-2.0e+99999, "-Infinity");
}
